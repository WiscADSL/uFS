...
public:
  ...
  explicit radix_tree(Compare pred)
      : m_size(0), m_root(NULL), m_predicate(pred) {}
...
radix_tree<K, T, Compare>::longest_match(const K &key) {
  if (m_root == NULL)
...
template <typename K, typename T, typename Compare>
void radix_tree<K, T, Compare>::greedy_match(const K &key,
                                             std::vector<iterator> &vec) {
  radix_tree_node<K, T, Compare> *node;
...
template <typename K, typename T, typename Compare>
void radix_tree<K, T, Compare>::greedy_match(
    radix_tree_node<K, T, Compare> *node, std::vector<iterator> &vec) {
  if (node->m_is_leaf) {
...
template <typename K, typename T, typename Compare>
radix_tree_node<K, T, Compare> *
radix_tree<K, T, Compare>::append(radix_tree_node<K, T, Compare> *parent,
                                  const value_type &val) {
  int depth;
  int len;
...
template <typename K, typename T, typename Compare>
radix_tree_node<K, T, Compare> *
radix_tree<K, T, Compare>::prepend(radix_tree_node<K, T, Compare> *node,
                                   const value_type &val) {
  int count;
  int len1, len2;
  ...
  radix_tree_node<K, T, Compare> *node_a =
      new radix_tree_node<K, T, Compare>(m_predicate);
